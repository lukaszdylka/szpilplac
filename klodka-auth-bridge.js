...
(function(){
  ...
  function showAccountDone(row,mode,idx){
    ...
    try{if(window.game){window.game.status=row.won?"won":"lost";window.game.mode=mode;window.game.idx=idx;window.game.__accountDone=true;}window.current="";}catch(e){}
