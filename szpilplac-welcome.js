...
(function(){
  ...
  function injectStyle(){
    ...
    style.textContent =
      ...
      ".szp-welcome-list li{display:grid;grid-template-columns:30px minmax(0,1fr);gap:10px;align-items:start;padding:10px;border:1px solid var(--line,#c9bfa6);border-radius:13px;background:var(--surface2,#f3ecda)}"+
      ".szp-welcome-list .szp-welcome-mark{width:28px;height:28px;display:grid;place-items:center;align-self:start;border:1px solid rgba(191,138,58,.42);border-radius:999px;background:rgba(191,138,58,.16);color:var(--gold,#bf8a3a);font-family:Oswald,system-ui,sans-serif;font-size:13px;font-weight:700;line-height:1}"+
      ".szp-welcome-list b{display:block;margin-bottom:2px;color:var(--ink,#23201a);font-size:13px}"+
      ".szp-welcome-list li>div>span{display:block;color:var(--ink2,#6a6150);font-size:12px;line-height:1.35}"+
    ...
    scrim.innerHTML =
      '<div class="szp-welcome-box">'+
        '<div class="szp-welcome-inner">'+
          ...
          '<p class="szp-welcome-lead">Krótko: grasz w gry dnia i tygodnia, zbierasz punkty i odznaki, zapisujesz wyniki i sprawdzasz ranking.</p>'+
