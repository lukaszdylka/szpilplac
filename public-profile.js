/* Szpilplac public-profile bridge v1
   Zachowuje tylko:
...
(function(){
  ...
  async function enhanceRanking(){
    ...
    if(list&&window.MutationObserver){
      ...
      new MutationObserver(function(){
        clearTimeout(timer);
        timer=setTimeout(function(){removeLegacySocialUi();addPublicLinks();},60);
  ...
  console.info("Szpilplac public-profile bridge "+VERSION);
})();
